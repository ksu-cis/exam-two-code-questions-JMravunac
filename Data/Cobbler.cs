...
namespace ExamTwoCodeQuestions.Data
{
    public class Cobbler : IOrderItem, INotifyPropertyChanged
    {
        ...
        public FruitFilling fruit = FruitFilling.Peach;
        /// <summary>
        ...
        public FruitFilling Fruit 
        {
            ...
            set
            {
                ...
                PropertyChanged?.Invoke(this, new PropertyChangedEventArgs("FruitPeach"));
                PropertyChanged?.Invoke(this, new PropertyChangedEventArgs("FruitCherry"));
                PropertyChanged?.Invoke(this, new PropertyChangedEventArgs("FruitBlueBerry"));
            } 
        }

        public bool FruitPeach
        {
